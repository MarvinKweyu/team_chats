defmodule TeamChatsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TeamChatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TeamChatsWeb.Gettext, "errors", msg, opts)
    end
  end
